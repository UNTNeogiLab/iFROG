...
grid_b = griddat((xbg,ybg), databbo, (xgrid, ygrid), method='nearest')
grid_m = griddat((xmg,ymg), datamos2, (xgrid, ygrid), method='nearest')
...
# 
# =============================================================================
grid_z0 = griddat((xfilt,yfilt), divfilt.real, (xgrid, ygrid), method='nearest')
